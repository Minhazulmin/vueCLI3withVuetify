...
const routes = [
    {
        ...
        children: [
            ...
            { path: 'jobs-and-career', name: 'blog', component: () => import('../views/pages/JobsAndCareer.vue') },
            { path: 'book-store', name: 'about', component: () => import('../views/pages/BookStore.vue') }, 
            ...
            { path: 'skills-development', name: 'contact', component: () => import('../views/pages/SkillsDevelopment.vue') },
