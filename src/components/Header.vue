...
export default {
   data: () => ({
      ...
      menus:[
        ...
        {title:"Skills Development" , url:'skills-development'},
        {title:"Jobs & Career" , url:'jobs-and-career'},
        {title:"Book Store" , url:'book-store'},
        {title:"Islamic" , url:'islamic'},
        {title:"Free Learn" , url:'free-learn'}
        ]
    }),
